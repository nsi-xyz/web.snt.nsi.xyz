    ...
    <div id="layout">
        ...
        <div id="main">
            ...
            <div class="content">
                ...
                <h2 class="content-subhead">Modifier le cookie relatif à l'énigme 8</h2>
                <p class="p-content">Pour résoudre cette énigme, il va falloir modifier un cookie. Ce cookie contient pour l'instant un nombre commençant par 404. Vous revez remplacer ce nombre par <span class="p-code"><?php echo $_SESSION["target_value_8"]; ?></span>. Attention, il ne faut en aucun cas modifier le cookie de session.<br>Après avoir supprimer le cookie, veillez rafraîchir la page en utilisant la touche <kbd>F5</kbd>.</p>
                <?php
