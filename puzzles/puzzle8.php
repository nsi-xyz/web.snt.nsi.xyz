    ...
    <div id="layout">
        ...
        <div id="main">
            ...
            <div class="content">
                ...
                <h2 class="content-subhead">Modifier le cookie relatif à l'énigme 8</h2>
                <p class="p-content">Pour résoudre cette énigme, il va falloir <a href="../help.php#Modifier / supprimer un cookie" class="link">modifier un cookie</a>. Ce cookie contient pour l'instant un nombre commençant par <span class="p-code">404</span>. Vous revez remplacer ce nombre par <span class="p-code"><?php echo $_SESSION["target_value_8"]; ?></span>. Attention, il ne faut en aucun cas modifier le cookie de session.<br>Après avoir supprimer le cookie, pensez à <a href="../help.php#Comment rafraîchir / actualiser une page web" class="link">rafraîchir la page</a>.</p>
                <?php
