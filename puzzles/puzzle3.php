    ...
    <div id="layout">
        ...
        <div id="main">
            ...
            <div class="content">
                ...
                <h2 class="content-subhead">Le commentaire dans la feuille de style</h2>
                <p class="p-content">Dans la feuille de style de ce site, il y a des commentaires. Vous devez <a href="../help.php#Localiser des fichiers externes" class="link">localiser</a> la feuille de style et le <strong><?php echo $pos == 1 ? $pos."er" : $pos."ème"; ?></strong> commentaire de cette dernière.</p>
                <?php
                if (!puzzleIsResolved()) {
