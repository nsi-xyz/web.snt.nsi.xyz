    ...
    <div id="layout">
        ...
        <div id="main"> <?php echo $slot == 2 ? '<!--'.$_SESSION["magic_word_1"].'-->' : ''; ?>
            ...
            <div class="content">
                ...
                <p class="p-content">Sur cette page, a été cachée un mot mystère. Pour résoudre cette énigme, il faut trouver le mot mystère. Ce mot mystère n'est ni <q>mot</q> ni <q>mystère</q>. La légende raconte que sur une page d'un site web, on peut cacher du texte dans le code de la page HTML.</p>
